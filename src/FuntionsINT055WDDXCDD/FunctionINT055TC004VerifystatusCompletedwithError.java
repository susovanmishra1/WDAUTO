...
public class FunctionINT055TC004VerifystatusCompletedwithError extends BaseClass {
...
//		gl.clickElement(Elements.workday_SignInButton, "workday_SignInButton");
	...
	public void VerifystatusCompletedwithError(String Intigration_ID,String Status) throws Exception {
...
//		gl.verifystrings(Elements.workday_Statusfailed, Status,"Status");
        gl.clickElement(Elements.CompletedWithError, "CompletedWithError");
		
		gl.verifystrings(Elements.CompletedwithErrorvalue, Status,"Status");
		gl.ScrollPage();
//		CompletedWithError
...
//        gl.clickElementReport(Elements.OutputFiles, "OutputFiles");
		gl.getFieldText(Elements.CompletedwithErrorMessage, "CompletedwithErrorMessage");
