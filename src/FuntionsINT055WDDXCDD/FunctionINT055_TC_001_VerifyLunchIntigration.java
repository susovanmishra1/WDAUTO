...
public class FunctionINT055_TC_001_VerifyLunchIntigration extends BaseClass {
...
//		gl.clickElement(Elements.workday_SignInButton, "workday_SignInButton");
	...
	public void verifyLunchIntigrationSucessfully(String Intigration_ID,String Status) throws Exception {
...
//		gl.clickElement(Elements.workday_IEvents, "workday_IntigrationEvents");
		...
		gl.getFieldText(Elements.IntegrationSystems,"IntegrationSystems - INT055-RequisitionDetails-WD-DXCDD ");
