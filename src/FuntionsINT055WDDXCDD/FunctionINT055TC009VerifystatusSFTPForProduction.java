...
public class FunctionINT055TC009VerifystatusSFTPForProduction extends BaseClass {
...
//		gl.clickElement(Elements.workday_SignInButton, "workday_SignInButton");
	...
	public void VerifystatusSFTPForProd(String Intigration_ID,String Status) throws Exception {
...
//		gl.clickElement(Elements.IService, "INT055-RequisitionDetails-WD-DXCDD");
//		gl.getFieldText(Elements.BusinessProceeDefination,"Integration Process Event for INT055-RequisitionDetails-WD-DXCDD (TOP LEVEL)");
...
//		System.out.println("Status");
		Thread.sleep(5000);
		gl.verifystrings(Elements.SFTP, Status,"SFTP");
//		gl.ScrollPage();
