...
public class FunctionINT055TC007VerifystatusCorrectReport extends BaseClass {
...
//		gl.clickElement(Elements.workday_SignInButton, "workday_SignInButton");
	...
	public void VerifystatusCorrectReport(String Intigration_ID,String Status) throws Exception {
...
//		gl.clickElement(Elements.IService, "INT055-RequisitionDetails-WD-DXCDD");
		gl.getFieldText(Elements.RPT1,"RPT - INT055 - Pending Requisition Details - WD - DXCDD");
