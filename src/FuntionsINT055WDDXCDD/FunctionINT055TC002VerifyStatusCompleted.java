...
public class FunctionINT055TC002VerifyStatusCompleted extends BaseClass {
...
//		gl.clickElement(Elements.workday_SignInButton, "workday_SignInButton");
	...
	public void VerifyStatusCompleted(String Intigration_ID,String Status) throws Exception {
...
//		driver.findElement(By.xpath("//div[@data-automation-id='pex-search-result-header']")).click();
		...
		gl.getFieldText(Elements.workday_StatusCompleted,"StatusCompleted");
