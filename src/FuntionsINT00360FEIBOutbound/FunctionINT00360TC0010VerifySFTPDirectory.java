...
public class FunctionINT00360TC0010VerifySFTPDirectory extends BaseClass {
...
//		gl.clickElement(Elements.workday_SignInButton, "workday_SignInButton");
	...
	public void verifySFTPDirectory(String Intigration_ID,String Status) throws Exception {
...
//		gl.ClickButton(Elements.workday_searchicon, "workday_searchicon");
        ...
        gl.getFieldText(Elements.SFTPDirectory,"SFTPDirectory");
       	Thread.sleep(5000);
		gl.verifystrings(Elements.SFTPDirectory, Status,"SFTPDirectory");
