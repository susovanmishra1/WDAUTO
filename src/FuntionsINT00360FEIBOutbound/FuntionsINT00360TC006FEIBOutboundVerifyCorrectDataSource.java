...
public class FuntionsINT00360TC006FEIBOutboundVerifyCorrectDataSource extends BaseClass {
...
//		gl.clickElement(Elements.workday_SignInButton, "workday_SignInButton");
	...
	public void VerifyCorrecDataSource(String Intigration_ID,String Status) throws Exception {
...
//		driver.findElement(By.xpath("//div[@data-automation-id='pex-search-result-header']")).click();
		gl.clickElement(Elements.EIBOutboundLink, "INT055-RequisitionDetails-WD-DXCDD");
//        Thread.sleep(5000);
//	   
...
//		System.out.println("Status");
		Thread.sleep(5000);
		gl.verifystrings(Elements.VerifyDataSource, Status,"DataSource");
		gl.getobjecttext(Elements.VerifyDataSource,"VerifyDataSource");
