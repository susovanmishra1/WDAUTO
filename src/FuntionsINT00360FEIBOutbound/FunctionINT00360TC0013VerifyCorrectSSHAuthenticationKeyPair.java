...
public class FunctionINT00360TC0013VerifyCorrectSSHAuthenticationKeyPair extends BaseClass {
...
//		Thread.sleep(10000);
	...
	public void VerifyCorrectSSHAuthenticationKeyPair(String Intigration_ID,String Status) throws Exception {
...
//	
		...
		gl.getFieldText(Elements.AuthenticationKeyPair,"UserId-hrit_ssh:hrit_ssh ");
		gl.verifystrings(Elements.AuthenticationKeyPair,Status, "AuthenticationKeyPair");
