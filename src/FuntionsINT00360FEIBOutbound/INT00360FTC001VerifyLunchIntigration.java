...
public class INT00360FTC001VerifyLunchIntigration extends BaseClass {
...
//		Thread.sleep(10000);
	...
	public void VerifyLunchIntigration(String Intigration_ID) throws Exception {
...
//		gl.clickElement(Elements.workday_IEvents, "workday_IntigrationEvents");
		...
		gl.getFieldText(Elements.VerifyIntigrationSystems, "INT00360F - National Identifier - EIB - Outbound");
		Thread.sleep(4000);
		gl.ScreenShotReport(Intigration_ID);
//		gl.verifystrings(Elements.workday_Status, Status,"Status");
