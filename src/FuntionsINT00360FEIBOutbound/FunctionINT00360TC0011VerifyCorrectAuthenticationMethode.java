...
public class FunctionINT00360TC0011VerifyCorrectAuthenticationMethode extends BaseClass {
...
//		Thread.sleep(10000);
	...
	public void VerifyCorrectAuthenticationMethode(String Intigration_ID,String Status) throws Exception {
...
//	
		...
		gl.getFieldText(Elements.SSHAuthentication,"Authentication: SSH ");
		gl.verifystrings(Elements.SSHAuthentication,Status, "SSHAuthentication");
