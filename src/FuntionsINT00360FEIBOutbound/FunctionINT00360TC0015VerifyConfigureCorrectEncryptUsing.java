...
public class FunctionINT00360TC0015VerifyConfigureCorrectEncryptUsing extends BaseClass {
...
//		Thread.sleep(10000);
	...
	public void VerifyConfigureCorrectEncryptUsing(String Intigration_ID,String Status) throws Exception {
...
//	
		...
		gl.getFieldText(Elements.EncryptUsing,"File Name = wkd_hrd_ghr0360.dat ");
		gl.verifystrings(Elements.EncryptUsing,Status, "AuthenticationKeyPair");
