...
public class FunctionINT00360TC007VerifyTransformTypeAndFile extends BaseClass {
...
//		gl.clickElement(Elements.workday_SignInButton, "workday_SignInButton");
	...
	public void VerifyTransformTypeAndFile(String Intigration_ID,String Status,String Events) throws Exception {
...
//      Thread.sleep(5000);
		gl.ScrollPage();
//		gl.clickElement(Elements.IServiceLink, "INT055-RequisitionDetails");
		
//		gl.clickElement(Elements.IService, "INT055-RequisitionDetails-WD-DXCDD");
		gl.getFieldText(Elements.TransformationType,"Custom Transformation");
		gl.getFieldText(Elements.TransformationExce,"INT00360F_SMO11 (INT00360F_Personal NID Data_IMO_ver1 (1).xsl)");
		gl.verifystrings(Elements.TransformationType, Status,"TransformationType");
		gl.verifystrings(Elements.TransformationExce, Events,"TransformationExce");
...
//		Thread.sleep(5000);
//		gl.verifystrings(Elements.RPT1, Status,"RPT");
//		gl.ScrollPage();
