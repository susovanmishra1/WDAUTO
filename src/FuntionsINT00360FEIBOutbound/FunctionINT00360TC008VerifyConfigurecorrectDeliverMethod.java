...
public class FunctionINT00360TC008VerifyConfigurecorrectDeliverMethod extends BaseClass {
...
//		Thread.sleep(10000);
	...
	public void VerifyConfigurecorrectDeliverMethod(String Intigration_ID,String Status) throws Exception {
...
//		gl.clickElement(Elements.IService, "INT055-RequisitionDetails-WD-DXCDD");
		gl.getFieldText(Elements.SFTPLink,"SFTP");
		gl.verifystrings(Elements.SFTPLink, "SFTP" , Status);
