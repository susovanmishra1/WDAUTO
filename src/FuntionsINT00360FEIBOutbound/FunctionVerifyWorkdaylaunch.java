...
//		gl.clickElement(Elements.workday_SignInButton, "workday_SignInButton");
	...
	public void verifyLoginAndSearch(String Intigration_ID) throws Exception {
...
//		gl.clickElement(Elements.workday_searchicon, "workday_searchicon");
		gl.getFieldText(Elements.INT00360FNationalIdentifierEIBOutbound,"INT00360FNationalIdentifierEIBOutbound");
//		gl.ClickButton(Elements.workday_searchicon, "workday_searchicon");
		Thread.sleep(15000);
