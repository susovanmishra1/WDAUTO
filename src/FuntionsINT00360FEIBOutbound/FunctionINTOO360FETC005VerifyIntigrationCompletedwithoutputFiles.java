...
public class FunctionINTOO360FETC005VerifyIntigrationCompletedwithoutputFiles extends BaseClass {
...
//		gl.clickElement(Elements.workday_SignInButton, "workday_SignInButton");
	...
	public void VerifyIntigrationCompletedwithoutputFiles(String Intigration_ID,String Status,String OutPutFiles) throws Exception {
...
//	   
		...
		gl.clickElement(Elements.EIBIntegration_Events, "workday_IntigrationEvents");
		System.out.println("Click Sucessfully");
		System.out.println("Status");
		Thread.sleep(5000);
//		gl.verifystrings(Elements.CompletedwithError, Status,"Status");
		gl.ScrollPage();
        gl.clickElementReport(Elements.OutputFiles, "OutputFiles");
        gl.verifystrings(Elements.EIBOutputFilesLink, OutPutFiles, "OutPutFiles");
		gl.getobjecttextreport(Elements.EIBOutputFilesLink, "OutputFilesLink");
