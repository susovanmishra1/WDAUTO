...
public class FunctionINT00360TC0014VerifyConfigureWithCorrectFileName extends BaseClass {
...
//		Thread.sleep(10000);
	...
	public void VerifyConfigureWithCorrectFileName(String Intigration_ID,String Status) throws Exception {
...
//	
		...
		gl.getFieldText(Elements.correctFilename,"File Name = wkd_hrd_ghr0360.dat ");
		gl.verifystrings(Elements.correctFilename,Status, "AuthenticationKeyPair");
