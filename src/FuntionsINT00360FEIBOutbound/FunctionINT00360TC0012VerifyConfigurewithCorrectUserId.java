...
public class FunctionINT00360TC0012VerifyConfigurewithCorrectUserId extends BaseClass {
...
//		Thread.sleep(10000);
	...
	public void VerifyConfigurewithCorrectUserId(String Intigration_ID,String Status) throws Exception {
...
//	
		...
		gl.getFieldText(Elements.UserId,"UserId-hrit_ssh:hrit_ssh ");
		gl.verifystrings(Elements.UserId,Status, "UserId");
