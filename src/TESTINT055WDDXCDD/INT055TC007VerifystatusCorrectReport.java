...
public class INT055TC007VerifystatusCorrectReport {
	/**
	 * Created by
	 */
   ...
   @DataProvider
	public Object[][] data(ITestContext context) throws BiffException, IOException {
		ExcelLib xl = new ExcelLib("VerifystatusCorrectReport7", "TC001");
...
//		INT055TC005VerifystatusCompletedwithoutputfiles
		FuntionsINT055WDDXCDD.FunctionINT055TC007VerifystatusCorrectReport wday7 = new FuntionsINT055WDDXCDD.FunctionINT055TC007VerifystatusCorrectReport();
		wday7.beforemethod();
		wday7.Login();
	}
	...
	public void searchPositionFromExcel(String Intigration_ID,String Status) throws Exception {
		FuntionsINT055WDDXCDD.FunctionINT055TC007VerifystatusCorrectReport wday7 = new FuntionsINT055WDDXCDD.FunctionINT055TC007VerifystatusCorrectReport();
		wday7.beforemethod();
		wday7.VerifystatusCorrectReport(Intigration_ID,Status);
