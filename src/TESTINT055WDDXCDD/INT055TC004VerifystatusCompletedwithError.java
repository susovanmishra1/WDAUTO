...
public class INT055TC004VerifystatusCompletedwithError {
	/**
	 * Created by
	 */
   ...
   @DataProvider
	public Object[][] data(ITestContext context) throws BiffException, IOException {
		ExcelLib xl = new ExcelLib("IntegrationwithError", "TC001");
	...
	public void searchPositionFromExcel(String Intigration_ID,String Status) throws Exception {
		FuntionsINT055WDDXCDD.FunctionINT055TC004VerifystatusCompletedwithError wday = new FuntionsINT055WDDXCDD.FunctionINT055TC004VerifystatusCompletedwithError();
		wday.beforemethod();
		wday.VerifystatusCompletedwithError(Intigration_ID,Status);
	}
