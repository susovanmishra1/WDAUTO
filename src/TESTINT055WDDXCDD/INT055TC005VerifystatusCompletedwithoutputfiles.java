...
public class INT055TC005VerifystatusCompletedwithoutputfiles {
	/**
	 * Created by
	 */
   ...
   @DataProvider
	public Object[][] data(ITestContext context) throws BiffException, IOException {
		ExcelLib xl = new ExcelLib("CompletedwithOutput5", "TC001");
...
//		INT055TC005VerifystatusCompletedwithoutputfiles
		FuntionsINT055WDDXCDD.FunctionINT055TC005VerifystatusCompletedwithoutput wday5 = new FuntionsINT055WDDXCDD.FunctionINT055TC005VerifystatusCompletedwithoutput();
		wday5.beforemethod();
		wday5.Login();
	}
	...
	public void searchPositionFromExcel(String Intigration_ID,String Status) throws Exception {
		FuntionsINT055WDDXCDD.FunctionINT055TC005VerifystatusCompletedwithoutput wday5 = new FuntionsINT055WDDXCDD.FunctionINT055TC005VerifystatusCompletedwithoutput();
		wday5.beforemethod();
		wday5.VerifystatusCompletedwithoutput(Intigration_ID,Status);
