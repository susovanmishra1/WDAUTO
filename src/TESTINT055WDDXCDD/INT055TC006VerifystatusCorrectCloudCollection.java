...
public class INT055TC006VerifystatusCorrectCloudCollection {
	/**
	 * Created by
	 */
   ...
   @DataProvider
	public Object[][] data(ITestContext context) throws BiffException, IOException {
		ExcelLib xl = new ExcelLib("CorrectCloudCorrection", "TC001");
...
//		INT055TC005VerifystatusCompletedwithoutputfiles
		FuntionsINT055WDDXCDD.FunctionINT055TC006VerifystatusCorrectCloudCollection2 wday6 = new FuntionsINT055WDDXCDD.FunctionINT055TC006VerifystatusCorrectCloudCollection2();
		wday6.beforemethod();
		wday6.Login();
	}
	...
	public void searchPositionFromExcel(String Intigration_ID,String Status) throws Exception {
		FuntionsINT055WDDXCDD.FunctionINT055TC006VerifystatusCorrectCloudCollection2 wday6 = new FuntionsINT055WDDXCDD.FunctionINT055TC006VerifystatusCorrectCloudCollection2();
		wday6.beforemethod();
		wday6.VerifystatusCorrectcloudcollection(Intigration_ID,Status);
