...
public class INT055TC009VerifystatusSFTPForProduction {
	/**
	 * Created by
	 */
   ...
   @DataProvider
	public Object[][] data(ITestContext context) throws BiffException, IOException {
		ExcelLib xl = new ExcelLib("VerifystatusSFTPForProd9", "TC001");
...
//		INT055TC005VerifystatusCompletedwithoutputfiles
		FuntionsINT055WDDXCDD.FunctionINT055TC009VerifystatusSFTPForProduction wday9 = new FuntionsINT055WDDXCDD.FunctionINT055TC009VerifystatusSFTPForProduction();
		wday9.beforemethod();
		wday9.Login();
	}
	...
	public void searchPositionFromExcel(String Intigration_ID,String Status) throws Exception {
		FuntionsINT055WDDXCDD.FunctionINT055TC009VerifystatusSFTPForProduction wday9 = new FuntionsINT055WDDXCDD.FunctionINT055TC009VerifystatusSFTPForProduction();
		wday9.beforemethod();
		wday9.VerifystatusSFTPForProd(Intigration_ID,Status);
