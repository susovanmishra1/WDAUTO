...
public class INT00360TC0015VerifyConfiguredwithCorrectencryptusing {
	/**
	 * Created by
	 */
   ...
   @DataProvider
	public Object[][] data(ITestContext context) throws BiffException, IOException {
		ExcelLib xl = new ExcelLib("TC15VerifyConfigureCorrectEncry", "TC001");
...
//		INT055TC005VerifystatusCompletedwithoutputfiles
		FuntionsINT00360FEIBOutbound.FunctionINT00360TC0015VerifyConfigureCorrectEncryptUsing wday14 = new FuntionsINT00360FEIBOutbound.FunctionINT00360TC0015VerifyConfigureCorrectEncryptUsing();
		wday14.beforemethod();
		wday14.Login();
	}
	...
	public void searchPositionFromExcel(String Intigration_ID,String Status) throws Exception {
		FuntionsINT00360FEIBOutbound.FunctionINT00360TC0015VerifyConfigureCorrectEncryptUsing wday14 = new FuntionsINT00360FEIBOutbound.FunctionINT00360TC0015VerifyConfigureCorrectEncryptUsing();
		wday14.beforemethod();
		wday14.VerifyConfigureCorrectEncryptUsing(Intigration_ID,Status);
