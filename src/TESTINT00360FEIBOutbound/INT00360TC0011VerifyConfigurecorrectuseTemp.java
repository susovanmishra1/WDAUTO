...
public class INT00360TC0011VerifyConfigurecorrectuseTemp {
	/**
	 * Created by
	 */
   ...
   @DataProvider
	public Object[][] data(ITestContext context) throws BiffException, IOException {
		ExcelLib xl = new ExcelLib("TC11VerifyCorrectUseTempFile", "TC001");
...
//		INT055TC005VerifystatusCompletedwithoutputfiles
		FuntionsINT00360FEIBOutbound.FunctionINT00360TC0011VerifyConfigureCorrectUseTemp wday11 = new FuntionsINT00360FEIBOutbound.FunctionINT00360TC0011VerifyConfigureCorrectUseTemp();
		wday11.beforemethod();
		wday11.Login();
	}
	...
	public void searchPositionFromExcel(String Intigration_ID,String Status) throws Exception {
		FuntionsINT00360FEIBOutbound.FunctionINT00360TC0011VerifyConfigureCorrectUseTemp wday11 = new FuntionsINT00360FEIBOutbound.FunctionINT00360TC0011VerifyConfigureCorrectUseTemp();
		wday11.beforemethod();
		wday11.VerifyCorrectUseTempFile(Intigration_ID,Status);
