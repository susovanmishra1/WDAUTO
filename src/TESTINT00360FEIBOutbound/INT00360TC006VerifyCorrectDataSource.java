...
public class INT00360TC006VerifyCorrectDataSource {
	/**
	 * Created by
	 */
   ...
   @DataProvider
	public Object[][] data(ITestContext context) throws BiffException, IOException {
		ExcelLib xl = new ExcelLib("TC006VerifyDataSource", "TC001");
...
//		INT055TC005VerifystatusCompletedwithoutputfiles
		FuntionsINT00360FEIBOutbound .FuntionsINT00360TC006FEIBOutboundVerifyCorrectDataSource wday6 = new FuntionsINT00360FEIBOutbound .FuntionsINT00360TC006FEIBOutboundVerifyCorrectDataSource();
		wday6.beforemethod();
		wday6.Login();
	}
	...
	public void searchPositionFromExcel(String Intigration_ID,String Status) throws Exception {
		FuntionsINT00360FEIBOutbound .FuntionsINT00360TC006FEIBOutboundVerifyCorrectDataSource wday6 = new FuntionsINT00360FEIBOutbound .FuntionsINT00360TC006FEIBOutboundVerifyCorrectDataSource();
		wday6.beforemethod();
		wday6.VerifyCorrecDataSource(Intigration_ID,Status);
