...
public class INT00360TC0011VerifyCorrectAuthenticationMethod {
	/**
	 * Created by
	 */
   ...
   @DataProvider
	public Object[][] data(ITestContext context) throws BiffException, IOException {
		ExcelLib xl = new ExcelLib("TC11VerifyAuthenticationMaryhod", "TC001");
...
//		INT055TC005VerifystatusCompletedwithoutputfiles
		FuntionsINT00360FEIBOutbound.FunctionINT00360TC0011VerifyCorrectAuthenticationMethode wday11 = new FuntionsINT00360FEIBOutbound.FunctionINT00360TC0011VerifyCorrectAuthenticationMethode();
		wday11.beforemethod();
		wday11.Login();
	}
	...
	public void searchPositionFromExcel(String Intigration_ID,String Status) throws Exception {
		FuntionsINT00360FEIBOutbound.FunctionINT00360TC0011VerifyCorrectAuthenticationMethode wday11 = new FuntionsINT00360FEIBOutbound.FunctionINT00360TC0011VerifyCorrectAuthenticationMethode();
		wday11.beforemethod();
		wday11.VerifyCorrectAuthenticationMethode(Intigration_ID,Status);
