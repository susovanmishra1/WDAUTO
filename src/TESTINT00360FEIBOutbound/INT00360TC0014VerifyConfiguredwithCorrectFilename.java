...
public class INT00360TC0014VerifyConfiguredwithCorrectFilename {
	/**
	 * Created by
	 */
   ...
   @DataProvider
	public Object[][] data(ITestContext context) throws BiffException, IOException {
		ExcelLib xl = new ExcelLib("TC14ConfiguredWithCorrectFil", "TC001");
...
//		INT055TC005VerifystatusCompletedwithoutputfiles
		FuntionsINT00360FEIBOutbound.FunctionINT00360TC0014VerifyConfigureWithCorrectFileName wday14 = new FuntionsINT00360FEIBOutbound.FunctionINT00360TC0014VerifyConfigureWithCorrectFileName();
		wday14.beforemethod();
		wday14.Login();
	}
	...
	public void searchPositionFromExcel(String Intigration_ID,String Status) throws Exception {
		FuntionsINT00360FEIBOutbound.FunctionINT00360TC0014VerifyConfigureWithCorrectFileName wday14 = new FuntionsINT00360FEIBOutbound.FunctionINT00360TC0014VerifyConfigureWithCorrectFileName();
		wday14.beforemethod();
		wday14.VerifyConfigureWithCorrectFileName(Intigration_ID,Status);
