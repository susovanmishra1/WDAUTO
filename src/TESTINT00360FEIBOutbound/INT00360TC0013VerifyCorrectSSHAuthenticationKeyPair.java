...
public class INT00360TC0013VerifyCorrectSSHAuthenticationKeyPair {
	/**
	 * Created by
	 */
   ...
   @DataProvider
	public Object[][] data(ITestContext context) throws BiffException, IOException {
		ExcelLib xl = new ExcelLib("TC13VerifyCorrectSSHAuthentic", "TC001");
...
//		INT055TC005VerifystatusCompletedwithoutputfiles
		FuntionsINT00360FEIBOutbound.FunctionINT00360TC0013VerifyCorrectSSHAuthenticationKeyPair wday13 = new FuntionsINT00360FEIBOutbound.FunctionINT00360TC0013VerifyCorrectSSHAuthenticationKeyPair();
		wday13.beforemethod();
		wday13.Login();
	}
	...
	public void searchPositionFromExcel(String Intigration_ID,String Status) throws Exception {
		FuntionsINT00360FEIBOutbound.FunctionINT00360TC0013VerifyCorrectSSHAuthenticationKeyPair wday13 = new FuntionsINT00360FEIBOutbound.FunctionINT00360TC0013VerifyCorrectSSHAuthenticationKeyPair();
		wday13.beforemethod();
		wday13.VerifyCorrectSSHAuthenticationKeyPair(Intigration_ID,Status);
